      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="md:col-span-2">
          <Tabs defaultValue="academic" className="animate-fade-in">
            <TabsList className="mb-6 bg-white border border-border/60 p-1 shadow-sm">
              <TabsTrigger
                value="academic"
              ...
              <TabsTrigger
                value="financial"
                className="data-[state=active]:bg-emerald-50 data-[state=active]:text-emerald-700 data-[state=active]:shadow-none"
              >
                Financial Standing
              </TabsTrigger>
              <TabsTrigger
              ...
              <Card className="shadow-card border border-border/60 overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-blue-50 to-white border-b border-border/60">
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-blue-700">Academic Records</CardTitle>
                      <CardDescription>
                        Academic standing:{" "}
                        <Badge
                          variant="outline"
            ...
            <TabsContent value="financial" className="mt-0 animate-fade-in">
              <Card className="shadow-card border border-border/60 overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-emerald-50 to-white border-b border-border/60">
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-emerald-700">Financial Standing</CardTitle>
                      <CardDescription>
                        Account Balance:{" "}
                        <span
                          className={
            ...
            <TabsContent value="achievements" className="mt-0 animate-fade-in">
              <Card className="shadow-card border border-border/60 overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-amber-50 to-white border-b border-border/60">
                  <CardTitle className="text-amber-700">Achievements & Recognition</CardTitle>
    ...
    <Card className="overflow-hidden border border-border/60 shadow-sm hover:shadow-md transition-shadow duration-200">
      <div className="p-5">
        <div className="flex justify-between items-start mb-3">
          <h3 className="font-medium text-primary-900">{achievement.name}</h3>
