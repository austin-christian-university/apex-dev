...
export function JobPromotionForm({ onSubmit, onCancel, isSubmitting = false }: JobPromotionFormProps) {
  const [formData, setFormData] = useState<Partial<JobPromotionSubmission>>({
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => handleInputChange('promotion_title', e.target.value)}
            placeholder="Senior Developer"
            required
          />
          {errors.promotion_title && <p className="text-sm text-destructive">{errors.promotion_title}</p>}
        </div>

        {/* Date of Promotion */}
        <div className="space-y-2">
          <Label htmlFor="date_of_promotion">Date of Promotion *</Label>
          <Input
            id="date_of_promotion"
            type="date"
            value={formData.date_of_promotion}
            onChange={(e) => handleInputChange('date_of_promotion', e.target.value)}
            required
          />
          {errors.date_of_promotion && <p className="text-sm text-destructive">{errors.date_of_promotion}</p>}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="john.manager@company.com"
            required
          />
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          placeholder="Describe your new role, responsibilities, and achievements that led to this promotion..."
          rows={3}
          required
        />
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">
          Upload photos of promotion letters, announcement emails, or other documentation
        </p>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          placeholder="Any additional information about this promotion..."
          rows={2}
        />
      </div>
